<picture>
  ...
  <img alt="auto_cut_bot README cover" src="./images/readme-cover-light.svg">
</picture>

<div align="center">
  <p>
    <a href="https://auto-cut-bot.wiki/docs/latest/getting-started/auto_cut_bot-overview">English</a> |
    <a href="https://auto-cut-bot.wiki/cn/docs/latest/getting-started/auto_cut_bot-overview">简体中文</a> |
    <a href="https://auto-cut-bot.wiki/zh-Hant/docs/latest/getting-started/auto_cut_bot-overview">繁體中文</a> |
    <a href="https://auto-cut-bot.wiki/es/docs/latest/getting-started/auto_cut_bot-overview">Español</a> |
    <a href="https://auto-cut-bot.wiki/fr/docs/latest/getting-started/auto_cut_bot-overview">Français</a> |
    <a href="https://auto-cut-bot.wiki/id/docs/latest/getting-started/auto_cut_bot-overview">Bahasa Indonesia</a> |
    <a href="https://auto-cut-bot.wiki/ja/docs/latest/getting-started/auto_cut_bot-overview">日本語</a> |
    <a href="https://auto-cut-bot.wiki/ko/docs/latest/getting-started/auto_cut_bot-overview">한국어</a> |
    <a href="https://auto-cut-bot.wiki/ru/docs/latest/getting-started/auto_cut_bot-overview">Русский</a> |
  ...
  <p>
    ...
    <a href="https://x.com/auto_cut_bot_project">X</a> ·
...
🐈 **auto_cut_bot** is an ultra-lightweight, open-source, self-hosted personal AI agent framework written in Python. It runs in a WebUI, terminal, or chat apps and combines tools, long-term memory, MCP integrations, model routing, multi-agent delegation, scheduled automation, and an OpenAI-compatible API in a small, readable core.

## Start Here

| You want to... | Go to |
|---|---|
| Install auto_cut_bot with no terminal/config background | [Start Without Technical Background](./docs/start-without-technical-background.md) |
...
| Deploy to the cloud or keep auto_cut_bot running as a service | [Deployment](./docs/deployment.md) |

## What can auto_cut_bot do?

auto_cut_bot is a self-hosted personal AI agent runtime. It can:
...
```bash
uv tool install auto-cut-bot-ai
```

**Install from PyPI with pip**

```bash
python -m pip install auto-cut-bot-ai
```

If pip reports `externally-managed-environment` on macOS or Linux, use the one-command installer, `uv tool install auto-cut-bot-ai`, `pipx install auto-cut-bot-ai`, or install inside a virtual environment.
...
```bash
auto_cut_bot --version
```

If `auto_cut_bot` is not on `PATH`, invoke it through the method that installed it: reuse the recommended installer's command, use `uv tool run --from auto-cut-bot-ai auto_cut_bot ...` or `pipx run --spec auto-cut-bot-ai auto_cut_bot ...`, or use the Python executable from the environment where pip installed the package.

## 🚀 Quick Start

**Open auto_cut_bot in your browser**
...
auto_cut_bot gateway logs
auto_cut_bot gateway restart
auto_cut_bot gateway stop
```

**Prefer a gateway-first workflow?**

```bash
auto_cut_bot gateway
```
...
Use `auto_cut_bot gateway --background` for the same direct entry point without keeping the terminal attached. For automatic startup and supervision by the operating system, see [Deployment](./docs/deployment.md).
...
```bash
auto_cut_bot agent -m "Hello!"
```

The one-shot form is useful for a quick provider check, shell scripts, and local automation. If you have not configured a model yet, run `auto_cut_bot webui` and open **Settings → Models** first.
...
If auto_cut_bot worked for you, a star on GitHub is the simplest way to support the project.
...
- Want to run auto_cut_bot in chat apps like Telegram, Discord, WeChat or Feishu? See [Chat Apps](./docs/chat-apps.md)
...
<p align="center">
  <img src="images/auto_cut_bot_webui.png" alt="auto_cut_bot webui preview" width="900">
</p>
...
<p align="center">
  <img src="images/auto_cut_bot_arch.png" alt="auto_cut_bot architecture" width="800">
</p>
...
Browse the [repo docs](./docs/README.md) for the latest features and GitHub development version, or visit [auto-cut-bot.wiki](https://auto-cut-bot.wiki/docs/latest/getting-started/auto_cut_bot-overview) for the stable release documentation.
...
- Talk to your auto_cut_bot with familiar chat apps: [Chat App AI Agent](./docs/guides/chat-app-ai-agent.md) · [Chat Apps](./docs/chat-apps.md)
- Schedule or trigger agent work: [Automations](./docs/automations.md)
- Configure providers, web search, MCP, and runtime behavior: [Configuration](./docs/configuration.md)
- Integrate auto_cut_bot with local tools and automations: [OpenAI-Compatible API](./docs/openai-api.md) · [Python SDK](./docs/python-sdk.md)
- Run auto_cut_bot with Docker or as a Linux service: [Deployment](./docs/deployment.md)
...
<p align="center">
  <em> Thanks for visiting ✨ auto_cut_bot!</em><br><br>
  <img src="https://visitor-badge.laobi.icu/badge?page_id=HKUDS.auto_cut_bot&style=for-the-badge&color=00d4ff" alt="Views">
</p>
