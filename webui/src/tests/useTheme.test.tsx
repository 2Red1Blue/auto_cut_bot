...
describe("useTheme", () => {
  beforeEach(() => {
    localStorage.removeItem("auto_cut_bot-webui.theme");
  ...
  it("keeps browser chrome in sync with the selected app theme", () => {
    localStorage.setItem("auto_cut_bot-webui.theme", "dark");
    ...
    expect(localStorage.getItem("auto_cut_bot-webui.theme")).toBe("light");
  });
});
