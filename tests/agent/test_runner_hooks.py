...
from auto_cut_bot.providers.base import LLMProvider, LLMResponse, LLMUsage, ToolCallRequest
...
async def test_runner_measures_stream_generation_without_time_to_first_token():
    ...
    with patch(
        "auto_cut_bot.agent.runner.time.perf_counter",
...
async def test_runner_calls_run_level_hooks_on_success():
    from auto_cut_bot.agent.hook import AgentHook, AgentRunHookContext
    from auto_cut_bot.agent.runner import AgentRunner
