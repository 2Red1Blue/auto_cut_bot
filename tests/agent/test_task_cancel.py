...
class TestHandleStop:
    ...
    async def test_close_mcp_cancels_active_turn_before_resources(self):
        ...
        with patch("auto_cut_bot.agent.loop.agent_context.close_mcp", AsyncMock()):
...
class TestDispatch:
    ...
    async def test_run_logs_and_continues_after_leaked_cancelled_error(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "auto_cut_bot.agent.loop.logger.warning",
    ...
    async def test_dispatch_streaming_preserves_message_metadata(self):
        from auto_cut_bot.bus.events import InboundMessage
        from auto_cut_bot.bus.outbound_events import StreamDeltaEvent, StreamEndEvent
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("auto_cut_bot.agent.tools.filesystem.ListDirTool.execute", fake_execute)
