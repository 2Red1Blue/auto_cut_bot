...
from auto_cut_bot.agent.context import ContextBuilder, TranscriptInput
...
from auto_cut_bot.cron.session_turns import CRON_HISTORY_META, CRON_TRIGGER_META
from auto_cut_bot.providers.base import LLMProvider, LLMResponse, LLMUsage, ProviderConversationState
...
from auto_cut_bot.session.goal_state import GOAL_STATE_KEY
from auto_cut_bot.session.keys import (
...
async def test_stop_preserves_runtime_checkpoint_for_next_turn(tmp_path: Path) -> None:
    from auto_cut_bot.command.builtin import cmd_stop
