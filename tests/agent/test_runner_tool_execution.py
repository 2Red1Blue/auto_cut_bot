...
from auto_cut_bot.providers.openai_responses.parsing import parse_response_output
...
def _load_entry_point_plugin(tool_cls: type[Tool], tmp_path) -> ToolRegistry:
    ...
    with patch("auto_cut_bot.agent.tools.loader.entry_points", return_value=[mock_ep]):
