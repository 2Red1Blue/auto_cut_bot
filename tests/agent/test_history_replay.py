...
from auto_cut_bot.session.manager import Session, replay_max_messages_for_context
...
@pytest.mark.asyncio
async def test_process_message_replays_with_canonical_token_and_message_budgets(
    tmp_path: Path,
) -> None:
    ...
    assert get_history.call_args.kwargs == {
        "max_messages": replay_max_messages_for_context(32_768),
