...
from auto_cut_bot.cli.commands import SafeFileHistory as LegacySafeFileHistory
from auto_cut_bot.cli.terminal import SafeFileHistory, _sanitize_surrogates
...
class TestSanitizeSurrogates:
    ...
    def test_emoji_already_correct(self):
        ...
        assert _sanitize_surrogates("hello 🐈 auto_cut_bot") == "hello 🐈 auto_cut_bot"
...
class TestSafeFileHistory:
    ...
    def test_emoji_preserved(self, tmp_path):
        hist = SafeFileHistory(str(tmp_path / "history"))
        hist.store_string("hello 🐈 auto_cut_bot")
        entries = list(hist.load_history_strings())
        assert entries[0] == "hello 🐈 auto_cut_bot"
