...
def test_launcher_passes_the_canonical_model_preset_to_the_tui(
    ...
    monkeypatch.setattr("auto_cut_bot.cli.tui_launcher._resolve_tui_command", lambda: ["nanobot-tui"])
...
def test_gateway_reuse_can_return_before_the_webui_endpoint_is_ready(
    ...
    monkeypatch.setattr("auto_cut_bot.gateway.GatewayRuntime", FakeRuntime)
    monkeypatch.setattr("auto_cut_bot.cli.tui_launcher._webui_endpoint_reachable", lambda _url: False)
