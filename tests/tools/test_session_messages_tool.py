...
from auto_cut_bot.agent.tools.session_messages import (
    ListSessionsTool,
...
from auto_cut_bot.session.session_handles import SessionHandle, SessionHandleResolver
...
async def test_reply_timeout_observes_background_delivery_failure(
    ...
    with patch("auto_cut_bot.agent.tools.session_messages.logger") as logger:
