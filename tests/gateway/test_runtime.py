...
from auto_cut_bot.gateway import GatewayRuntime, GatewayRuntimePaths, GatewayStartOptions, GatewayStatus
...
def test_terminate_windows_falls_back_when_ctrl_break_is_rejected(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("auto_cut_bot.process_runtime.os.kill", fake_kill)
