...
from auto_cut_bot.llm_usage import get_llm_usage_store
from auto_cut_bot.llm_usage.models import LLMCallRecord
...
def test_settings_payload_includes_versioned_docs(
    ...
    assert payload["docs"] == {
        "version": "0.2.3",
        "base_url": "https://auto_cut_bot.wiki/docs/0.2.3",
        "chat_apps_url": "https://auto_cut_bot.wiki/docs/0.2.3/getting-started/chat-apps",
...
def test_provider_models_payload_returns_online_openai_codex_models(
    ...
    monkeypatch.setattr(
        "auto_cut_bot.webui.settings_models.get_oauth_model_catalog",
