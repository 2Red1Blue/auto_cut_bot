"""Lightweight WebSocket test client for integration testing the auto_cut_bot WebSocket channel.

Provides an async ``WsTestClient`` class and token-issuance helpers that
integration tests can import and use directly::

    from auto_cut_bot.channels.websocket.tests.ws_test_client import WsTestClient
...
from auto_cut_bot.webui.http_utils import http_response
