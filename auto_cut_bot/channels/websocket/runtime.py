"""WebSocket server channel: auto_cut_bot acts as a WebSocket server and serves connected clients."""
...
from auto_cut_bot.command.builtin import USER_SHELL_COMMAND, builtin_command_starts_agent_turn
...
from auto_cut_bot.session.goal_state import goal_state_ws_blob
from auto_cut_bot.session.model_selection import model_preset_from_metadata
...
from auto_cut_bot.webui.cli_apps_api import normalize_cli_app_mentions
from auto_cut_bot.webui.forking import handle_webui_fork_chat
from auto_cut_bot.webui.gateway_services import GatewayServices
...
from auto_cut_bot.webui.mcp_presets_api import normalize_mcp_preset_mentions
from auto_cut_bot.webui.metadata import (
    WEBSOCKET_TURN_OWNER_METADATA_KEY,
    WEBUI_SYSTEM_COMMAND_TURN_PREFIX,
    WEBUI_TURN_METADATA_KEY,
)
from auto_cut_bot.webui.session_access import (
    SessionMention,
    WebuiSessionAccess,
    session_mentions_runtime_context,
)
from auto_cut_bot.webui.sidebar_state import write_webui_sidebar_state
from auto_cut_bot.webui.temporary_chats import TemporaryChatError
from auto_cut_bot.webui.transcript import WEBUI_TRANSCRIPT_INCOMPLETE_KEY
from auto_cut_bot.webui.transcription_ws import webui_transcription_event
from auto_cut_bot.webui.websocket_logging import websockets_server_logger
...
class WebSocketConfig(Base):
    ...
    - ``token_issue_path``: If non-empty, **GET** (HTTP/1.1) to this path returns JSON
      ...
      auto_cut_bot and shares the asyncio loop, use a thread or async HTTP client for GET—do not call
...
class WebSocketChannel(BaseChannel):
    ...
    async def start(self) -> None:
        from auto_cut_bot.utils.logging_bridge import redirect_lib_logging
