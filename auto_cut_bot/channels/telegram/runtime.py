...
class TelegramChannel(BaseChannel):
    ...
    def _normalize_telegram_command(content: str) -> str:
        """Map Telegram-safe command aliases back to canonical auto_cut_bot commands."""
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm auto_cut_bot.\n\n"
    ...
    def _queue_key_for_message(message: Message) -> str:
        """Return the final auto_cut_bot session key used for ordered Telegram ingress."""
