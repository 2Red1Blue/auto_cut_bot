...
import auto_cut_bot.channels.whatsapp.runtime as whatsapp_module
from auto_cut_bot.bus.events import OutboundMessage
from auto_cut_bot.bus.queue import MessageBus
from auto_cut_bot.channels.whatsapp.runtime import (
    WhatsAppChannel,
...
async def test_unauthorized_dm_uses_base_pairing_flow(monkeypatch) -> None:
    _patch_neonize_api(monkeypatch)
    monkeypatch.setattr("auto_cut_bot.channels.base.generate_code", lambda _ch, _sid: "ABCD-EFGH")
