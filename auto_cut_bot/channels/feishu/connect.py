...
from auto_cut_bot.channels.feishu.instances import DEFAULT_INSTANCE_ID, validate_instance_id
...
def _default_instance_name(instance_id: str) -> str:
    return "auto_cut_bot" if instance_id == DEFAULT_INSTANCE_ID else f"auto_cut_bot {instance_id}"
