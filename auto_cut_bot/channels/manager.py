...
def _default_webui_dist() -> Path | None:
    ...
    try:
        import auto_cut_bot.web as web_pkg  # type: ignore[import-not-found]
    except ImportError:
        return None
...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        from auto_cut_bot.optional_features import ensure_enabled_channel_dependencies
