...
from auto_cut_bot.agent.context import ContextBuilder, PersistedPromptContextResolver, TranscriptInput
...
from auto_cut_bot.agent.runner import (
...
from auto_cut_bot.agent.tools.message import capture_message_deliveries
...
from auto_cut_bot.llm_usage.context import source_from_request
from auto_cut_bot.providers.base import LLMProvider, LLMUsage, ProviderConversationState
...
from auto_cut_bot.session.manager import SESSION_CACHE_MAX_SIZE, Session, SessionManager
from auto_cut_bot.session.model_selection import (
    SESSION_MODEL_PRESET_METADATA_KEY,
    model_preset_from_metadata,
)
from auto_cut_bot.session.recovery import (
...
from auto_cut_bot.session.summary import (
...
class AgentLoop:
    ...
    def __init__(
        ...
        # AUTO_CUT_BOT_MAX_CONCURRENT_REQUESTS: unset or <=0 means unlimited.
        _max = int(os.environ.get("AUTO_CUT_BOT_MAX_CONCURRENT_REQUESTS", "0"))
        ...
        *on_stream_end(resuming, merge_next)*: called when a streaming session finishes.
        ...
        try:
            ...
            result = await self.runner.run(AgentRunSpec(
                ...
                # Sustained goals may legitimately exceed AUTO_CUT_BOT_LLM_TIMEOUT_S; idle stall
                # is still capped by AUTO_CUT_BOT_STREAM_IDLE_TIMEOUT_S in streaming providers.
