...
from auto_cut_bot.security.workspace_policy import WorkspaceBoundaryError, resolve_allowed_path
from auto_cut_bot.utils.artifacts import (
    ArtifactError,
...
if TYPE_CHECKING:
    ...
    from auto_cut_bot.config.schema import ProviderConfig
    ...
    def _resolve_reference_image(self, value: str) -> str:
        ...
        try:
            ...
            raise ImageGenerationError(
                "reference_images must be inside the workspace or auto_cut_bot media directory"
            ) from exc
...
async def reload_image_generation_tool(state: Any, registry: ToolRegistry) -> dict[str, Any]:
    ...
    return {
        "ok": True,
        "message": "Image generation settings applied without restarting auto_cut_bot.",
