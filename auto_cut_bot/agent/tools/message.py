...
from auto_cut_bot.agent.tools.context import ToolContext, current_request_context
from auto_cut_bot.agent.tools.path_utils import resolve_workspace_path
from auto_cut_bot.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
...
class MessageTool(Tool):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from auto_cut_bot.utils.helpers import strip_think
