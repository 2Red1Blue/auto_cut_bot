...
from auto_cut_bot.utils.helpers import build_image_content_blocks
...
_VOLCENGINE_TRAFFIC_TAG = "auto_cut_bot"
...
def _resolve_url_safe(url: str) -> tuple[bool, str, tuple[str, ...]]:
    ...
    from auto_cut_bot.security.network import resolve_url_target
...
def _fetch_client_kwargs(proxy: str | None, timeout: float) -> dict[str, Any]:
    from auto_cut_bot.security.network import httpx_env_proxy_mounts
...
def _unsafe_url_request_error(exc: BaseException) -> str | None:
    from auto_cut_bot.security.network import UnsafeURLRequestError
    ...
    async def _search_olostep(self, query: str, n: int) -> str:
        try:
            ...
            return ToolResult.error(
                ...
                "Run `auto_cut_bot plugins enable olostep`."
            )
