...
from auto_cut_bot.agent.tools.file_state import FileStates, _hash_file, current_file_states
from auto_cut_bot.agent.tools.path_utils import resolve_workspace_path
...
from auto_cut_bot.security.workspace_access import current_tool_workspace
from auto_cut_bot.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
        ...
        **kwargs: Any,
        ...
        try:
            ...
            try:
                ...
                from auto_cut_bot.utils.document import _is_text_extension
    ...
    def _read_pdf(self, fp: Path, pages: str | None) -> str:
        from auto_cut_bot.utils.document import PdfPageRangeError, PdfSafetyError, extract_pdf_pages
    ...
    def _read_office_doc(
        ...
        from auto_cut_bot.utils.document import open_document_line_source
