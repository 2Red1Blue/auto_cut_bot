...
from auto_cut_bot.providers.base import ProviderCallContext, ProviderConversationState
from auto_cut_bot.runtime_context import public_history_messages
from auto_cut_bot.session.manager import (
    MIN_COMPACTED_REPLAY_MESSAGES,
    Session,
    SessionManager,
)
from auto_cut_bot.session.summary import session_summary_from_metadata
...
from auto_cut_bot.utils.workspace_prompts import (
...
class MemoryStore:
    ...
    def build_dream_tools(self) -> ToolRegistry:
        ...
        from auto_cut_bot.agent.skills import BUILTIN_SKILLS_DIR
        from auto_cut_bot.agent.tools.apply_patch import ApplyPatchTool
        from auto_cut_bot.agent.tools.file_state import FileStates
        from auto_cut_bot.agent.tools.filesystem import EditFileTool, ReadFileTool, WriteFileTool
        from auto_cut_bot.agent.tools.registry import ToolRegistry
