...
This directory contains built-in skills that extend auto_cut_bot's capabilities.
...
When skills reference large local documentation or logs, prefer auto_cut_bot's built-in
