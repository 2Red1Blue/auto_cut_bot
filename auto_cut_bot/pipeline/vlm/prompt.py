...
def resolve_vlm_prompt_template(prompt_version: str) -> str:
    ...
    from .contextual_video_prompt import (
        ...
        VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V19_TEMPLATE,
        VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V19_VERSION,
        VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V20_TEMPLATE,
        VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V20_VERSION,
        VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V21_TEMPLATE,
    ...
    if prompt_version == VLM_CONTEXTUAL_FACT_ANCHORED_EVENT_CORE_VIDEO_PROMPT_VERSION:
        return VLM_CONTEXTUAL_FACT_ANCHORED_EVENT_CORE_VIDEO_PROMPT_TEMPLATE
    if prompt_version == VLM_CONTEXTUAL_ENUM_DISAMBIGUATED_FACT_ANCHORED_EVENT_CORE_VIDEO_PROMPT_VERSION:
        return VLM_CONTEXTUAL_ENUM_DISAMBIGUATED_FACT_ANCHORED_EVENT_CORE_VIDEO_PROMPT_TEMPLATE
    if prompt_version == VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_VERSION:
        return VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_TEMPLATE
    if prompt_version == VLM_CONTEXTUAL_CANDIDATE_CORE_VIDEO_PROMPT_VERSION:
        return VLM_CONTEXTUAL_CANDIDATE_CORE_VIDEO_PROMPT_TEMPLATE
    if prompt_version == VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V19_VERSION:
        return VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V19_TEMPLATE
    if prompt_version == VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V20_VERSION:
        return VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V20_TEMPLATE
    if prompt_version == VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V21_VERSION:
        return VLM_CONTEXTUAL_MINIMAL_CORE_VIDEO_PROMPT_V21_TEMPLATE
    ...
    if prompt_version == VLM_CONTEXTUAL_REQUIRED_EMPTY_ARRAY_CORE_VIDEO_PROMPT_VERSION:
        return VLM_CONTEXTUAL_REQUIRED_EMPTY_ARRAY_CORE_VIDEO_PROMPT_TEMPLATE
    if prompt_version == VLM_CONTEXTUAL_STRICT_WIRE_CORE_VIDEO_PROMPT_VERSION:
        return VLM_CONTEXTUAL_STRICT_WIRE_CORE_VIDEO_PROMPT_TEMPLATE
