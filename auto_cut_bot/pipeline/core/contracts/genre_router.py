...
LEGACY_ARYA_PATH = ROOT / "autocut_core" / "_references" / "editorial-golden-case-arya.json"
MIN_CONFIDENCE = 0.75
...
def golden_case_path(case_id: str) -> Path:
    ...
    # Legacy Arya fixture
    if case_id == "arya-rebirth-revenge-final-cut-v1" and LEGACY_ARYA_PATH.is_file():
...
def validate_story_route(
    ...
    if "arya-rebirth-revenge-final-cut-v1" in observed and story.get(
        "genre_profile"
