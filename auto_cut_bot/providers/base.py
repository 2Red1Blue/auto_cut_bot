...
from auto_cut_bot.utils.helpers import sanitize_surrogates_deep

if TYPE_CHECKING:
    from auto_cut_bot.llm_usage.models import LLMCallRecord

STREAM_IDLE_TIMEOUT_ENV = "AUTO_CUT_BOT_STREAM_IDLE_TIMEOUT_S"
...
class LLMProvider(ABC):
    ...
    def _observe_llm_call(
        ...
        *,
        ...
        try:
            from auto_cut_bot.llm_usage.context import current_llm_usage_source
            from auto_cut_bot.llm_usage.models import LLMCallRecord
