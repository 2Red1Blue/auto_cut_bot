...
from auto_cut_bot.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "auto_cut_bot.webui.thread_disk",
    "webui_transcript": "auto_cut_bot.webui.transcript",
    "webui_turn_helpers": "auto_cut_bot.session.webui_turns",
}
