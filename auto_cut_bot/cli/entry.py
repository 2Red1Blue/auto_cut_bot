...
from auto_cut_bot.cli.process_identity import set_cli_process_identity
...
def main() -> None:
    ...
    raw_args = sys.argv[1:]
    # Installed completion scripts call ``auto_cut_bot`` without positional arguments
    ...
    shell_completion = bool(os.environ.get("_AUTO_CUT_BOT_COMPLETE"))
    ...
    if agent_args is not None and (
        ...
        prog_name = "auto_cut_bot" if root_agent_alias else "auto_cut_bot agent"
