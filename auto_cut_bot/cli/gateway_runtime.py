...
from auto_cut_bot.gateway.runtime import GatewayInstance
...
def _run_gateway(
    ...
    *,
    ...
    from auto_cut_bot.llm_usage import record_llm_call
    ...
    async def run() -> None:
        ...
        try:
            ...
            tasks = [
                ...
                asyncio.create_task(_run_agent(), name="auto_cut_bot-agent-loop"),
                ...
                asyncio.create_task(
                    ...
                    name="auto_cut_bot-gateway-client-monitor",
                ),
            ]
