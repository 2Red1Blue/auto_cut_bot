...
This module owns auto_cut_bot's transcription behavior: config resolution,
...
HTTP details; those live in ``auto_cut_bot.providers.transcription``.
"""
...
from auto_cut_bot.config.loader import resolve_env_refs
...
from auto_cut_bot.utils.media_decode import FileSizeExceeded, save_base64_data_url
