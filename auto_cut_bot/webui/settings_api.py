...
from auto_cut_bot.config.loader import get_config_path, load_config, resolve_config_env_vars, save_config
...
_DOCS_LATEST_URL = "https://auto-cut-bot.wiki/docs/latest"
...
def _docs_payload() -> dict[str, Any]:
    ...
    base_url = f"https://auto-cut-bot.wiki/docs/{docs_version}"
    return {
