...
from auto_cut_bot.security.workspace_policy import WorkspaceBoundaryError, require_path_within
...
def delete_webui_skill(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix=".auto_cut_bot-delete-", dir=skills_root) as staging:
...
def _auto_cut_bot_metadata(metadata: dict[str, Any] | None) -> dict[str, Any]:
    ...
    payload = metadata_payload.get("auto_cut_bot", metadata_payload.get("openclaw", {}))
