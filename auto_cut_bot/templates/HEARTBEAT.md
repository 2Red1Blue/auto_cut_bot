...
<!--
This file is checked periodically by your auto_cut_bot agent. When auto_cut_bot gateway starts with gateway.heartbeat.enabled=true, it automatically registers a protected heartbeat cron job that reads this file.
