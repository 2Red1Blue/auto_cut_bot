#!/usr/bin/env python3
"""Deterministic admission and repair policy for VLM Analysis output.

VLM Analysis contains two different kinds of data:
...
POLICY_VERSION = "vlm-analysis-admission-v1"
...
class VlmAnalysisContractResult:
    """Canonical VLM Analysis value plus typed repair/audit findings."""
...
def supports_local_window_media_recovery(
    result: VlmAnalysisContractResult,
) -> bool:
...
def canonicalize_vlm_analysis(
    ...
    * removing an exact duplicate optional record.
    ...
    if (
        ...
        return VlmAnalysisContractResult(
