...
class AudioBoundaryPolicy:
    ...
    vad_threshold: float = 0.25  # demucs_vocals 轨（分离后干净，低阈值抓弱语音）
    vad_threshold_original: float = 0.45  # original_mix 轨（含 BGM，高阈值防误检）
    vad_threshold_no_vocals: float = 0.55  # no_vocals 轨（伴奏残留，最高阈值）
    ...
    def from_json(cls, path: str) -> "AudioBoundaryPolicy":
        ...
        return cls(
            ...
            vad_threshold=data.get("vad_threshold", 0.25),
            vad_threshold_original=data.get("vad_threshold_original", 0.45),
            vad_threshold_no_vocals=data.get("vad_threshold_no_vocals", 0.55),
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "vad_threshold_original": self.vad_threshold_original,
            "vad_threshold_no_vocals": self.vad_threshold_no_vocals,
