...
STAGE_VERSIONS: dict[str, str] = {
    ...
    # 写入 vlm_analysis batch job 的 stage_version 字段
    "source_windows": "vlm-first-v1",
    # plugins/ac_source_prep/stages/global_context —
    # API/script book-level context extraction (one-time)
    "global_context": "vlm-first-v1",
    # plugins/ac_source_prep/stages/vlm_analysis —
    # VLM window analysis (renamed from window_analysis)
    "vlm_analysis": "vlm-first-v1",
    # plugins/ac_source_prep/stages/confidence_check —
    # Quality gate, conditional ASR trigger
    "confidence_check": "vlm-first-v1",
    # plugins/ac_source_prep/stages/asr_transcript —
    # FunASR Paraformer 转录 + 说话人分离 (conditional: triggered by confidence_check)
    "asr_transcript": "vlm-first-asr-v1",
}
